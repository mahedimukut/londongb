        ...
        >
          ...
          <div className="space-y-6">
            <Benefit
              ...
              description="Your personal information and data are protected with bank-level encryption."
            />
            <Benefit
            ...
            <Benefit
              ...
              description="Save addresses, track orders, and manage returns effortlessly."
            />
          </div>
        </motion.div>
...
export default function LoginPage() {
  return (
    <>
      ...
      <Suspense
        fallback={
          <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-primary-50 to-brand-sky-50">
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ repeat: Infinity, duration: 1 }}
              className="w-12 h-12 border-4 border-t-brand-primary-600 border-b-brand-primary-300 rounded-full"
            />
          </main>
        }
      >
