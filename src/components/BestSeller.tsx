...
const BestSellerCard = ({ product }: { product: Product }) => {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-gray-200"
    >
      {/* Product Image */}
      <Link href={`/products/${product.slug}`}>
        <div className="relative overflow-hidden aspect-square">
          ...
          <div className="absolute top-3 left-3">
            <span className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white text-xs font-medium px-2 py-1 rounded shadow-sm">
          ...
          <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <button
              ...
              className="bg-gradient-to-r from-black to-gray-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-gray-800 hover:to-black transition-all shadow-lg disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              {isAddingToCart
                ? "Adding..."
                : product.stock === 0
...
export default function BestSellers() {
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR("/api/dashboard/products?limit=15&bestSeller=true", fetcher, {
  ...
  const handleRefresh = async () => {
    const toastId = toast.loading("Refreshing best sellers...", {
      position: "bottom-right",
    });
    ...
    try {
      ...
      toast.update(toastId, {
        render: "Failed to refresh best sellers",
        type: "error",
        isLoading: false,
        autoClose: 4000,
      });
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mb-4">Loading best sellers...</p>
    ...
    return (
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-red-600 mb-4">Failed to load best sellers</p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {products.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg mb-2">No best sellers found.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                onClick={handleRefresh}
