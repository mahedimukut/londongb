        ...
        <div className="relative overflow-hidden aspect-square">
          {product.images && product.images.length > 0 ? (
            ...
            <div className="w-full h-full bg-brand-neutral-100 flex items-center justify-center">
              <Trophy className="h-8 w-8 text-brand-neutral-400" />
            </div>
          )}

          {/* Best Seller Badge */}
          <div className="absolute top-2 left-2">
            <span className="bg-gradient-to-r from-brand-gold-500 to-brand-gold-600 text-white text-xs font-medium px-2 py-1 rounded shadow-sm">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <div className="flex justify-center mb-3 md:mb-4">
              <Trophy className="h-8 w-8 text-brand-gold-500" />
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {products.length === 0 && (
          <div className="text-center py-8 md:py-12">
            <Trophy className="h-12 w-12 text-brand-neutral-400 mx-auto mb-3 md:mb-4" />
